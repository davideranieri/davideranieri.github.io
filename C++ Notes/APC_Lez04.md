...
It is an **error** to copy orr try to access the vlaue of an invalid pointer; this error the compiler unlikely detect. The result of accessing an invalid pointer is *undefined*
